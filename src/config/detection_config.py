...
# --- 【平滑系数配置】 ---
# 范围 0.0 ~ 1.0，越小越平滑但延迟越高
SMOOTH_ALPHA_POS = 0.5  # 位置 (XYZ) 平滑系数
SMOOTH_ALPHA_ROT = 0.5   # 角度 (RxRyRz) 平滑系数
